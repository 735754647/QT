...
//    connect(ui->pushButton_2,&QPushButton::clicked,this,&MainWindow::pushData);
    // 图表添加两条曲线
...
//{
//    double xNumber = ui->LineX_2->text().toInt();
//    double yNumber = ui->LineY_2->text().toInt();

//    x.push_back(xNumber);
//    y.push_back(yNumber);
//    pPlot1->graph(0)->setData(x,y);
//    pPlot1->replot();
//    qDebug()<<"X "<<x;
//    qDebug()<<"Y "<<y;
//}
