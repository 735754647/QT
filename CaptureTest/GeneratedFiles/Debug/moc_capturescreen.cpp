...
QT_MOC_LITERAL(3, 36, 11) // "catureImage"
...
void CaptureScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalCompleteCature((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CaptureScreen::*_t)(QPixmap );
...
const QMetaObject CaptureScreen::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CaptureScreen.data,
      qt_meta_data_CaptureScreen,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CaptureScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CaptureScreen.stringdata0))
        return static_cast<void*>(const_cast< CaptureScreen*>(this));
...
// SIGNAL 0
void CaptureScreen::signalCompleteCature(QPixmap _t1)
{
